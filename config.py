...
UNLABELED_TEST_DIR = os.path.join(DATA_DIR, "MedImage-TestSet")  # unlabeled testset (for submission)
...
# Optional local Swin weights to avoid online download
...
# Split strategy
# =============================
# Default: single split; switch to k-fold via env
...
# =============================
# Mixup (optional; keep it light for glaucoma)
# =============================
